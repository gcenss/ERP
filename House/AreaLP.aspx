<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AreaLP.aspx.cs" Inherits="HouseMIS.Web.House.AreaLP" %>

<script>
    var txt1 = $("#txtName1").val(), txt2 = $("#txtName2").val(), txt3 = $("#txtName3").val();
    $(function () {
        var _xx = $("#" + txt2).val(); 
        var _cc = "", _vv = "", _bb = "", _nn = "";
        if (_xx != "" || _xx != null) {
