<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AreaC.aspx.cs" Inherits="HouseMIS.Web.House.AreaC" %>
<script>
    $(function () {
        var _xx = $("#mysfrmtxtArea2").val();
        var _cc = "", _vv = "", _bb = "", _nn = "";
        if (_xx != "" || _xx != null) {
    ...
    function closeVal() {
        ...
        $("#mysfrmtxtArea").val($("#tjName").html());
        $("#mysfrmtxtArea2").val(_vv2);
        $.pdialog.close('AreaVillage');
    }
    function seachXQ() {
        var items = "";
        $.ajax({
...
<style>
    ...
    #xqContent {
        OVERFLOW-Y: auto; OVERFLOW-X:hidden; width:490px; height:145px;
    }
    #qyContent span {
    ...
    .tabX td,.tabX th {
         padding:5px 0; border-bottom:1px solid #e1e1e1;
    }
</style>
...
<form id="form1" runat="server">
    <table class="tabX">
        <tr>
            <th width="60"><span style="color:red">已选项：</span></th>
            <td>
                <div id="tjContent"></div>
                <div id="tjName"></div>
            </td>
            <td width="60"><button type="button" onclick="closeVal()">确定</button></td>
        </tr>
        ...
        <tr>
            <th>商圈：</th>
            <td colspan="2"><div id="sqContent"></div></td>
        </tr>
        <tr>
            <th>小区：</th>
            <td colspan="2"><div id="xqContent"></div></td>
        </tr>
    </table>
    <%=pSon %>
</form>
