<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WeiXinTempleteList.aspx.cs" Inherits="HouseMIS.Web.House.Templete.WeiXinTempleteList" %>
...
<body>
    <div class="pageContent">
        <form name="pagerForm" id="pagerForm" runat="server" action="House/Templete/WeiXinTempleteList.aspx"
                 ...
                 <tr>
                     ...
                     <td>
                         <asp:DropDownList ID="ffrmShareType" runat="server" Height="20px" Width="126px" CssClass="required">
                             ...
                             <asp:ListItem Text="公众号图片" Value="公众号图片"></asp:ListItem>
                             <asp:ListItem Text="公众号简介" Value="公众号简介"></asp:ListItem>
                         </asp:DropDownList>
                     </td>
                     <td>
                         标题
                ...
                <asp:Repeater ID="rpt1" runat="server">
                    <ItemTemplate>
                        <tr target="MasterKeyValue" rel="<%#Eval("id")%>">
                            ...
                            <td>
                                <%# ParseTags(Eval("Title").ToString(),20) %>
                            </td>
                            <td>
                            <%# ParseTags(Eval("Contents") == null ? "" : Eval("Contents").ToString(), 40)%>
                            </td>
