<%@ Page Language="C#" AutoEventWireup="true" EnableViewStateMac="false" CodeBehind="HouseList.aspx.cs" Inherits="HouseMIS.Web.House.HouseList" EnableEventValidation='false' ViewStateEncryptionMode='Never' %>
                ...
                <div class="searchBar" id="HouseListSearchBar">
                    ...
                    <table class="searchContent">
                        <tr>
                            ...
                            <td class="dateRange">
                                ...
                                <asp:DropDownList ID="myffrmisefw" CssClass="frmLabel" runat="server">
                                    <asp:ListItem></asp:ListItem>
                    ...
                    <table class="searchContent">
                        <tr>
                            ...
                            <td class="dateRange">
                                <label>委托单号：</label>
                                <asp:TextBox ID="myffrmorderNum" runat="server" Width="80px"></asp:TextBox>
                            </td>
                            <td>
                            ...
                            <td>
                                <input type="checkbox" id="cHasVideo" runat="server" value="on" onclick="SetCheckValue(this, 'on', 'myffrmHasVideo')" />视频
                                <input type="hidden" id="myffrmHasVideo" runat="server" name="myffrmHasVideo" value="" />
                            </td>
                            <td>
                ...
                <div class="pageContent" style="padding: 0px 2px 2px 2px; position: static; display: inherit;">
                    ...
                    <div class='panelBar'>
                        <ul class='toolBar'>
                            ...
                            <%--<li><a class='add' id="sell" href='House/HouseList.aspx?OperType=0&NavTabId=<%=NavTabId %>' target="navTab" rel="<%=NavTabId %>" title="出售信息"><span>出售</span></a></li>
                    <li><a class='add' id="zu" href='House/HouseList.aspx?OperType=1&NavTabId=<%=NavTabId %>' target="navTab" rel="<%=NavTabId %>" title="出租房源"><span>出租</span></a></li>--%>
                            ...
                            <%=efw() %>
                            <%--       <li><a class='add' href='House/HouseForm.aspx?NavTabId=<%=NavTabId %>&doAjax=true&todo=1&Type=2' target='dialog' rel='dlg_page2' width='660' height='720' maxable='false' mask="true" title="添加新房房源"><span>添加新房房源</span></a></li>--%>
                            <%--                           <li><a class="add" href="House/HouseList.aspx?NavTabId=<%=NavTabId %>&doAjax=true&doType=addajk" rel="ids" target="selectedTodo" title="确定导入吗?"><span>导入安居客</span></a></li>
                             <li><a class='add' href='House/api58Login.aspx' target='dialog'  width='660' height='720' maxable='false' mask="true" title="添加到58"><span>导入58</span></a></li>--%>
                            ...
                            <%--<li><a class='edit' id="all" href='House/HouseList.aspx?NavTabId=<%=NavTabId %>' target="navTab" rel="<%=NavTabId %>" title="出售信息"><span>所有房源</span></a></li>--%>
                        </ul>
                    </div>
                    <div class='panelBar'>
                        <ul class='toolBar'>
                    ...
                    <asp:GridView ID="gv" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <%-- <asp:TemplateField HeaderText="实价(万)" SortExpression="min_price">
                                <ItemTemplate><%#Eval("min_price")%></ItemTemplate>
                            </asp:TemplateField>--%>
