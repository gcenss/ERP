<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HouseRentListFrom.aspx.cs" Inherits="HouseMIS.Web.House.HouseRentListFrom" %>

<script type="text/javascript">
    $(function () {
        $("#mysfhx").hide();
        $("#div_mysfrmFitmentID_Rent").hide();
        $('#mysfrmtxtRentArea').val($('#myffrmtxtRentArea').val());
        $('#mysfrmtxtRentArea_Item').val($('#myffrmtxtRentArea_Item').val());

        $('#mysfrmRent_Price1').val($('#myffrmRent_Price1').val());
        $('#mysfrmRent_Price2').val($('#myffrmRent_Price2').val());

        $('#mysfrmBuild_area1').val($('#myffrmRentarea1').val());
        $('#mysfrmBuild_area2').val($('#myffrmRentarea2').val());

        $('#mysfrmbuild_floor1').val($('#myffrmrentbuild_floor1').val());
        $('#mysfrmbuild_floor2').val($('#myffrmrentbuild_floor2').val());
        $('#mysfrmbuild_id').val($('#myffrmrentbuild_id').val());
        $('#mysfrmbuild_id2').val($('#myffrmrentbuild_id2').val());

        $('#mysfrmFitmentID').val($('#myffrmRentFitmentID').val());
        $('#mysfrmFName').val($('#myffrmRentFName').val());
        $('#mysfrmbuild_room').val($('#myffrmrentbuild_room').val());
        $('#mysfrmbuild_room2').val($('#myffrmrentbuild_room2').val());

        $('#mysfrmRentlandlord_tel2').val($('#myffrmrentlandlord_tel2').val());

        $("#sfrmStateID").val($('#myffrmRentStateID').val());
        $("#sfrmaType").val($('#ffrmaType').val());

        //首录人
        $("#mysfrmOwnerEmployeeID").val($('#myffrmOwnerEmployeeID').val());

        $('#mysfrmRentShi_id').val($('#myffrmRentShi_id').val());

        if ($("#myffrmRentHasKey").val() == "on") {
            $("#mysfrmRentHasKey").attr("checked", true);
        }
        if ($("#myffrmRentHasImage").val() == "on") {
            $("#mysfrmRentHasImage").attr("checked", true);
        }

        if ($("#myffrmrentform_bedroom").val() != "") {
            $("#mysfrmRentform_bedroom").val($("#myffrmrentform_bedroom").val());
            $("#mysfrmRentform_bedroom1").val($("#myffrmrentform_bedroom1").val());
            $("#mysfrmRentform_bedroom2").val($("#myffrmrentform_bedroom2").val());
        }
        if ($("#myffrmrentform_bedroom").val() == "自定义") { $("#mysfhx").show(); }


        $('#mysfrmRentform_bedroom').change(function () {
            var p1 = $(this).children('option:selected').val();//这就是selected的值 
            if (p1 == "自定义") {
                $('#mysfrmRentform_bedroom1').val("");
                $('#mysfrmRentform_bedroom2').val("");
                $("#mysfhx").show();
            }
            else {
                if (p1.split("-").length == 2 && p1 != "") {
                    $('#mysfrmRentform_bedroom1').val(p1.split("-")[0]);
                    $('#mysfrmRentform_bedroom2').val(p1.split("-")[1]);
                }
                else if (p1.split("-").length == 1 && p1 != "") {
                    $('#mysfrmRentform_bedroom1').val("999");
                    $('#mysfrmRentform_bedroom2').val("999");
                }
                else {
                    $('#mysfrmRentform_bedroom1').val("");
                    $('#mysfrmRentform_bedroom2').val("");
    ...
    $("#mysfrmFName").click(function () {
        ...
        if ($("#div_mysfrmFitmentID_Rent").is(":hidden")) {
            $("#div_mysfrmFitmentID_Rent").show();
        }
        else {
            $("#div_mysfrmFitmentID_Rent").hide();
        }
    ...
    function GetVl(obj) {
        try {
            ...
            $('#myffrmtxtRentArea').val($('#mysfrmtxtRentArea').val());
            $('#myffrmtxtRentArea_Item').val($('#mysfrmtxtRentArea_Item').val());
...
<body>
    <div class="pageContent">
        <form runat="server" id="pagerForm" method="post" action="House/HouseRentList.aspx" class="pageForm" onsubmit="return GetVl(this);">
            <div class="pageFormContent" layouth="58">
                <table class="sTab">
                    ...
                    <tr>
                        <th>区域:</th>
                        <td>
                            <a href='House/AreaV.aspx?NavTabId=<%=NavTabId %>&doAjax=true&tn1=mysfrmtxtRentArea&tn2=mysfrmtxtRentArea_Item&tn3=AreaRentVillage' target='dialog' rel='AreaRentVillage' width='580' height='380' fresh='true' mask="true" maxable='false' title="区域商圈小区选择">
                                <asp:TextBox ID="mysfrmtxtRentArea" runat="server" Width="115px" ReadOnly="true"></asp:TextBox>
                            </a>
                            <asp:TextBox ID="mysfrmtxtRentArea_Item" runat="server" Style="display: none;"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <th>租金:</th>
                        <td>
                            <asp:TextBox ID="mysfrmRent_Price1" runat="server" Style="width: 40px" onkeyup="value=value.replace(/[^0-9]/g,'')" onafterpaste="value=value.replace(/[^0-9]/g,'')"></asp:TextBox>
                            -
                       
                        <asp:TextBox ID="mysfrmRent_Price2" runat="server" Style="width: 40px" onkeyup="value=value.replace(/[^0-9]/g,'')" onafterpaste="value=value.replace(/[^0-9]/g,'')"></asp:TextBox>
                        </td>
                        <th>面积:</th>
                        <td>
                            <asp:TextBox ID="mysfrmBuild_area1" runat="server" Style="width: 40px" onkeyup="value=value.replace(/[^0-9]/g,'')" onafterpaste="value=value.replace(/[^0-9]/g,'')"></asp:TextBox>
                            -
                       
                        <asp:TextBox ID="mysfrmBuild_area2" runat="server" Style="width: 40px" onkeyup="value=value.replace(/[^0-9]/g,'')" onafterpaste="value=value.replace(/[^0-9]/g,'')"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <th>装修:</th>
                        <td>
                            ...
                            <div id="div_mysfrmFitmentID_Rent" style="padding-top: 8px; border: 1px solid #ccc; background: #e0dfdf; top: 120px; height: auto; position: absolute; z-index: 9999;">
                                <div style="cursor: pointer; float: right; margin: 10px;">
                                    <img onclick="CloseRoleCheck('div_mysfrmFitmentID_Rent')" src="/img/bar_close.gif">
                                </div>
                                <%=GetFitmentID() %>
                            </div>
                        </td>
                        <th>编号:</th>
                        <td>
                            <asp:TextBox ID="mysfrmRentShi_id" runat="server" Width="115px"></asp:TextBox>
                        </td>
                        <th>电话:</th>
                        <td>
                            <asp:TextBox ID="mysfrmRentlandlord_tel2" runat="server" CssClass="input_h" MaxLength="11"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <th>户型:</th>
                        <td>
                            <asp:DropDownList ID="mysfrmRentform_bedroom" runat="server" Width="70">
                            ...
                            <span id="mysfhx">
                                <asp:TextBox ID="mysfrmRentform_bedroom1" runat="server" Width="20px"></asp:TextBox>
                                -
                            <asp:TextBox ID="mysfrmRentform_bedroom2" runat="server" Width="20px"></asp:TextBox>
                            </span>
                        </td>
                ...
                <table class="sTab2">
                    <tr>
                        <th>登记日期:</th>
                        <td>
                            <asp:TextBox ID="mysfrmexe_date1" runat="server" CssClass="datewidth date"></asp:TextBox>
                            -
                       
                        <asp:TextBox ID="mysfrmexe_date2" runat="server" CssClass="datewidth date"></asp:TextBox>
                        </td>
                        <th>更新日期:</th>
                        <td>
                            <asp:TextBox ID="mysfrmupdate_date1" runat="server" CssClass="datewidth date"></asp:TextBox>
                            -
                       
                        <asp:TextBox ID="mysfrmupdate_date2" runat="server" CssClass="datewidth date"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <th>最后更进日期:</th>
                        <td>
                            <asp:TextBox ID="mysfrmFollowUp_Date1" runat="server" CssClass="datewidth date"></asp:TextBox>
                            -
                       
                        <asp:TextBox ID="mysfrmFollowUp_Date2" runat="server" CssClass="datewidth date"></asp:TextBox>
                        </td>
                        <th>房屋用途:</th>
                        <td>
                            <asp:DropDownList ID="sfrmUseID" runat="server" Width="55px"></asp:DropDownList>
                            类型:<asp:DropDownList ID="sfrmTypeCode" runat="server" Style="width: 100px;"></asp:DropDownList>
                        </td>
                    </tr>
                ...
                <table class="sTab3">
                    <tr>
                        <td>
                            <asp:CheckBox ID="mysfrmRentHasKey" runat="server" Text="钥匙" Width="65px"></asp:CheckBox>
                        </td>
                        <td>
                            <asp:CheckBox ID="mysfrmRentHasImage" runat="server" Text="照片" Width="65px"></asp:CheckBox>
                        </td>
                        <td>
                            <asp:CheckBox ID="mysfrmpastdue" runat="server" Text="满2年" Width="65px"></asp:CheckBox>
                        </td>
                        <td>
                            <asp:CheckBox ID="mysfrmEntrustType" runat="server" Text="独家" Width="65px"></asp:CheckBox>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:CheckBox ID="mysfrmIsVideo" runat="server" Text="视频房" Width="65px"></asp:CheckBox>
                        </td>
                        <td>
                            <asp:CheckBox ID="mysfrmIsLock" runat="server" Text="锁盘" Width="65px"></asp:CheckBox>
                        </td>
                        <td>
                            <asp:CheckBox ID="mysfrmIsBeiAn" runat="server" Text="备案" Width="75px"></asp:CheckBox>
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:CheckBox ID="mysfrmIsPrivate" runat="server" Text="私盘" Width="65px"></asp:CheckBox>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div style="display: none;">
                ...
                首录人:<asp:TextBox ID="mysfrmOwenEmployeeID" runat="server" CssClass="input_h"></asp:TextBox>
